...
-- 4단계: 확인
-- ================================================
SELECT '완료!' as 상태, COUNT(*) as 성과데이터 FROM ad_performance;
SELECT source as 매체, COUNT(*) as 개수, ROUND(SUM(cost)) as 총비용 FROM ad_performance GROUP BY source ORDER BY 총비용 DESC;
