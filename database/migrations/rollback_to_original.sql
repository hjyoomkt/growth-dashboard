-- ==========================================
-- 롤백 스크립트 (백업 결과 기반)
-- fix_data_access_security_v2.sql 적용 후 문제 발생 시 실행
-- 실제 서버의 백업 결과를 기반으로 원래 상태로 복원
-- ==========================================
...
-- 11. 광고그룹별 집계 함수 (원본 - campaign_name 없음)
...
-- 12. 광고별 집계 함수 (원본 - campaign_name, ad_group_name 없음)
