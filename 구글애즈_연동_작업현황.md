...
Google Ads: integrations.refresh_token_encrypted (BYTEA, pgcrypto)
Meta Ads: integrations.access_token_encrypted (BYTEA, pgcrypto) ← 같은 방식
조직 GCP: organizations.google_*_encrypted (TEXT, pgcrypto)
복호화: get_decrypted_token(p_api_token_id, p_token_type) RPC 함수
