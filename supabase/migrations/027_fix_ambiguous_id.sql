-- ============================================================================
-- 수정: "column reference 'id' is ambiguous" 오류 해결
-- 문제: eligible CTE에서 id 컬럼이 애매하게 참조됨
-- 해결: 명확한 alias 사용
-- ============================================================================
...
COMMENT ON FUNCTION get_next_pending_chunks IS '여러 청크 병렬 처리 (광고계정별 1개, 의존성+processing 확인) - ambiguous id 오류 수정';
